...
export default function Home() {
  const projects = [
    ...
    },
    {
      title: "地图笔记（UGC）",
      tag: "主 R · 从 0 到 1",
      desc: "长期关注骑手社区，洞察骑手自发分享地理信息的诉求，提出「地图笔记」产品概念。在无 PRD 阶段主动帮助产品构思方案，纳入产品侧 Q2 重点 OKR。",
      metrics: [
        { label: "指引数据覆盖", value: "35.6%→↑" },
    ...
    <main className="min-h-screen bg-white text-gray-900">
      ...
      <section className="pt-32 pb-20 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl text-gray-500 max-w-2xl leading-relaxed mb-10">
            ...
            累计 <span className="text-gray-900 font-medium">17 项 GUI 专利</span>。
          </p>
          ...
          <div className="grid sm:grid-cols-2 gap-10">
            <div>
              ...
              <p className="text-gray-500 leading-relaxed mb-4">
                ...
                先后在京东金融、美团买菜从事界面设计，后完成向用户体验（UX）方向的跨专业转型。
              </p>
              <p className="text-gray-500 leading-relaxed">
                长期负责<strong className="text-gray-700">美团到家履约配送</strong>场景的体验设计，
                后轮岗至平台推荐产品设计，并承担<strong className="text-gray-700">设计导师</strong>岗位。
              </p>
            </div>
            <div className="space-y-4">
              {[
                { period: "2016 – 2018", role: "用户界面设计师", org: "京东金融 · 移动研发部门" },
                { period: "2018 – 2020", role: "产品视觉设计师", org: "美团 · 小象事业部（买菜）" },
                { period: "2020 – 至今", role: "产品体验设计师", org: "美团 · 到家设计部 / 平台设计中心" },
              ].map((item) => (
      ...
      <footer className="border-t border-gray-100 py-8 px-6">
        <div className="max-w-4xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-2">
          <span className="text-sm text-gray-300">© 2025 高永乐 · 永乐</span>
          <span className="text-xs text-gray-300">产品体验设计师 · 美团</span>
        </div>
      </footer>
    </main>
  );
